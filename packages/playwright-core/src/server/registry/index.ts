...
const DOWNLOAD_PATHS = {
  'chromium': {
    ...
    'ubuntu24.04': 'builds/chromium/%s/chromium-linux.zip',
  ...
  'chromium-tip-of-tree': {
    ...
    'ubuntu24.04': 'builds/chromium-tip-of-tree/%s/chromium-tip-of-tree-linux.zip',
  ...
  'chromium-with-symbols': {
    ...
    'ubuntu24.04': 'builds/chromium/%s/chromium-with-symbols-linux.zip',
    ...
    'ubuntu24.04-arm64': 'builds/chromium/%s/chromium-with-symbols-linux-arm64.zip',
  ...
  'firefox': {
    ...
    'ubuntu24.04': 'builds/firefox/%s/firefox-ubuntu-24.04.zip',
  ...
  'firefox-beta': {
    ...
    'ubuntu24.04': 'builds/firefox-beta/%s/firefox-beta-ubuntu-24.04.zip',
    'ubuntu18.04-arm64': undefined,
  ...
  'webkit': {
    ...
    'ubuntu24.04': 'builds/webkit/%s/webkit-ubuntu-24.04.zip',
    'ubuntu18.04-arm64': undefined,
  ...
  'ffmpeg': {
    ...
    'ubuntu24.04': 'builds/ffmpeg/%s/ffmpeg-linux.zip',
